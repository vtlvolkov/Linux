...
function misc_install() {
  sudo apt-get -y install openconnect network-manager-openconnect network-manager-openconnect-gnome nemo conky-all nmap hashcat tshark reaver pyrit gqrx-sdr xterm sslstrip john ettercap-graphical mdk4 lighttpd dhcpd dsniff crunch php hydra cutycapt python3-pip python3-distutils
}
